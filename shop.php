    ...
    <header class="header_area">
        <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
            ...
            <nav class="classy-navbar" id="essenceNav">
                <!-- Logo -->
                <a class="nav-brand" href="<?php echo isset($_SESSION['user_id']) && isset($_SESSION['authenticated']) ? 'index_autentificat.php' : 'index.php'; ?>"><img src="img/core-img/logo_alb.png" alt=""></a>
                <!-- Navbar Toggler -->
                    ...
                    <div class="widget catagory mb-50">
                        ...
                        <div class="catagories-menu">
                            ...
                            <ul id="menu-content1" class="menu-content collapse show">
                                <li>
                                    <a href="#" data-toggle="collapse" data-target="#womenCategory">Women</a>
                                    <ul class="sub-menu collapse" id="womenCategory">
                                        <li><a href="?subcategory=all_women">All</a></li>
                                        <li><a href="?subcategory=dresses">Dresses</a></li>
                                        <li><a href="?subcategory=tops_blouses">Tops & Blouses</a></li>
                                        <li><a href="?subcategory=jeans">Jeans</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="#" data-toggle="collapse" data-target="#menCategory">Men</a>
                                    <ul class="sub-menu collapse" id="menCategory">
                                        <li><a href="?subcategory=all_men">All</a></li>
                                        <li><a href="?subcategory=t-shirts">T-Shirts</a></li>
                                        <li><a href="?subcategory=hoodies">Hoodies</a></li>
                                        <li><a href="?subcategory=pants">Pants</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="product-topbar d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="total-products">
                                        ...
                                        if (strcasecmp($subcategorie, 'all_women') === 0) {
                                            $count_query = "SELECT COUNT(*) AS total FROM products WHERE categorie = 'Women'";
                                        } elseif (strcasecmp($subcategorie, 'all_men') === 0) {
                                            $count_query = "SELECT COUNT(*) AS total FROM products WHERE categorie = 'Men'";
...
if (strcasecmp($subcategorie, 'all_women') === 0) {
    $sql = "SELECT * FROM products WHERE categorie = 'Women' $order_by_clause LIMIT $offset, $produse_pe_pagina";
} elseif (strcasecmp($subcategorie, 'all_men') === 0) {
    $sql = "SELECT * FROM products WHERE categorie = 'Men' $order_by_clause LIMIT $offset, $produse_pe_pagina";
} elseif (!empty($subcategorie)) {
