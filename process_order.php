...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $insertOrderQuery = "INSERT INTO orderss (user_id, first_name, last_name, country, street_address, postcode, county, city, phone_number, email_address, total_price, order_status)
        ...
        // Actualizează totalul comenzii în tabela orderss
        $updateTotalQuery = "UPDATE orderss SET total_price = '$totalPrice' WHERE order_id = '$orderId'";
